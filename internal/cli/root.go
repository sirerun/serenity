...
func newRootCmd() *cobra.Command {
	...
	root.AddCommand(newInitCmd(), newSyncCmd(), newExtractCmd(), newDoctorCmd(), newStatusCmd(), newCompactCmd(), newConnectorsCmd(), newSearchCmd(), newMigrateCmd(), newAskCmd(), newCheckCmd(), newConnectCmd(), newConfigCmd(), newCronCmd(), newCaptureCmd())
	return root
}
