...
// repo, and its caller (internal/cli's `serenity report`) records the
// result explicitly, the same "callers that drive the thing measure it"
// convention rebuild_timing.go documents for RecordRebuildTiming.
