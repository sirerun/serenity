# T23.3 HTTP/MCP concurrency receipt
...
tool held a shared mutex for 2 ms to model a serialized canonical writer.
...
of serialized work under concurrent load. It is not a sustainable throughput
or hosted capacity claim: the tool is synthetic, the server is in-process, and
