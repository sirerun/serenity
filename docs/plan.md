...
- [x] T2.9 Compaction gated by an approved disposition item + shard rollover at configured size (PR TBD, 2026-09-07, see docs/plans/E2-m2-reconcile.md and docs/roadmap.md for detail)
