...
- [x] T2.22 M2 exit: run the RFC AC checklist end to end on a laptop and record it (PR TBD, 2026-09-07, see docs/plans/E2-m2-reconcile.md and docs/roadmap.md for detail -- M2 is exit-verified, all five RFC §17 M2 ACs cleared for real)
