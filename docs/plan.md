...
- [x] T4.9 CLI vs protocol drift tests: search/recall, ask/synthesize, check/check_plan, inbox dispose/dispose, brief/brief over one fixture (PR #TBD, 2026-09-07 -- see docs/plans/E4-m4-serve-protocols.md for the full annotation; asserts CLI<->protocol-handler parity, a different axis from T4.20's still-open protocol<->gbrain conformance repair)
