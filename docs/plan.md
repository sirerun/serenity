...
### E2 -- M2: reconcile + entities + disposition queue + ladder calibration  -> docs/plans/E2-m2-reconcile.md  (4/22 checked in the epic file as of this pass -- T2.20 shipped 2026-09-07 (PR #82), T2.12 shipped 2026-09-06 (PR #78), T2.19 shipped 2026-09-06/07 (PR #75), T2.10 shipped 2026-09-06 (PR #74); wave-2a's blocked-by: [T1.23] was dropped 2026-09-05, see section 5. T2.1 also merged this session per docs/roadmap.md Shipped but its own mark-done is a separate task's responsibility, not yet flipped here)
