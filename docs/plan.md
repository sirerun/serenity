...
### E4 -- M4: serve + protocols  -> docs/plans/E4-m4-serve-protocols.md  (5/19, gated behind M2+M3; T4.3 and T4.18 were the cross-epic-startable tasks during E3 and both have now shipped -- ADR 011; T4.12 shipped 2026-09-07 (PR #88) and T4.10 shipped 2026-09-07 (PR #119), both cross-epic-startable the moment T2.1 landed, needing no other E2 wave-2a task -- see section 5; T4.18/T4.19 added 2026-09-02, ADR 012; T4.4 shipped 2026-09-07 (PR TBD, DISPOSITION v1 server -- `internal/server/disposition`: list_pending/dispose/capture/subscribe over the already-shipped `internal/disposition.Store`/`internal/events.Store`, the events package's first live producer -- see docs/roadmap.md Shipped for full detail), deps [T2.1, T2.20, T4.12, T4.3] all shipped by 2026-09-07)
