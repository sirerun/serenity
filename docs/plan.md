...
### E2 -- M2: reconcile + entities + disposition queue + ladder calibration  -> docs/plans/E2-m2-reconcile.md  (1/22; wave-2a's blocked-by: [T1.23] was dropped 2026-09-05 -- see section 5 -- T2.19 shipped 2026-09-06/07, PR #75)
