...
### E4 -- M4: serve + protocols  -> docs/plans/E4-m4-serve-protocols.md  (1/19, gated behind M2+M3; T4.3 and T4.18 are the cross-epic-startable tasks during E3 -- ADR 011; T4.18/T4.19 added 2026-09-02, ADR 012)
