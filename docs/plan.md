...
- [x] T2.15 Queue SLOs (`internal/queue/slo.go`) into `serenity status` (PR TBD, 2026-09-07, see docs/plans/E2-m2-reconcile.md and docs/roadmap.md for detail)
